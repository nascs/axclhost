...
typedef struct
{
      AX_S16 nHorOffset;       /* RW; range: [-1023, 1023]; the horizontal offset between image center and physical center of len */
      AX_S16 nVerOffset;       /* RW; range: [-1023, 1023];  the vertical offset between image center and physical center of len */
      AX_U16 nRadius;          /* RW; range: [0, 0.75 * MAX(nSrcWidth, nSrcHeight) of input picture]; out radius of gdc correction region */
      AX_U16 nSrcWidth;        /* RW; input picture width */
      AX_U16 nSrcHeight;       /* RW; input picture height */
      AX_U16 nOffsetLeft;      /* RW; range: [0, nSrcWidth]: The distance from the distorted image to the left */
      AX_U16 nOffsetRight;     /* RW; range: [0, nSrcWidth]: The distance from the distorted image to the right */
      AX_U16 nDstWidth;        /* RW; output picture width */
      AX_U16 nDstHeight;       /* RW; output picture height */
} AX_IVPS_LDCH_ATTR_T;
